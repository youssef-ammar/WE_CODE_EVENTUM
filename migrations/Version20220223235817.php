 ...
 */
final class Version20220223235817 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE topic CHANGE bookmark bookmarks VARCHAR(255) DEFAULT NULL');
    }
