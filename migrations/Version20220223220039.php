 ...
 */
final class Version20220223220039 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE topic CHANGE title title VARCHAR(255) NOT NULL, CHANGE image image VARCHAR(255) NOT NULL');
    }
