...
class ForumController extends AbstractController
{
  ...
  */
     ...
     */
    public function detailC($id,TranslatorInterface $translator,$lang): Response
    {
        $forums = $this->getDoctrine()->getRepository(Topic::class)->find($id);
        $this->transl($translator, $lang);
        return $this->render('Front/Forum/Forum_details.html.twig', ['items' => $forums,'lang'=>$lang,'id'=>$id]);
    }
